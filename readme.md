...
1. Установите количество перерывов(1 номер).
2. Установите время работы в минутах(2 номер).
3. Установите время перерыва в минутах(3 номер).
4. Нажмите **Старт**, после того как таймер пошел нельзя редактировать.
5. Если что то пошло не так, нажмите **Сброс**.
6. По завершении рабочего таймера начнётся таймер перерыва.
7. По окончании перерыва можно продолжить сессию.
8. Нельзя закрыть через Alt+F4, Alt+Tab или Диспетчер задач.  
